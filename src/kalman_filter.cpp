...
void viper_broadcaster_pose_ori_callback(const viper_tf2_broadcaster::viper_msg_pose_ori  &msg)
{
    x = msg.x;
    y = msg.y;
    z = msg.z;
...
ros::Publisher kalman_filter_pose_ori= n.advertise<viper_tf2_broadcaster::viper_msg_pose_ori>("kalman_filter_pose_ori", 1000);
