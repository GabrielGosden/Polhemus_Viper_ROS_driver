...
// executive cmds
	...
	, CMD_SENSOR_BLOCKCFG   /**  26         /reset,	sensor	none					p		cfg			sensornum						*/
...
typedef enum eViperFilterPresets
{
...
//! Valid Built-In Test result codes @ref BIT_STRUCT::bfCODE
...
*  8-11       | action | uint32_t    | A constant enumeration of type @ref eViperActions.
...
*  8-11       | fOriThresh     | float    | The orientation threshold, expressed in Euler Degrees.
*/
...
//! Payload for @ref CMD_SOURCE_SEL
/**
